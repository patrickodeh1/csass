...
class MessageTemplate(models.Model):
    ...
    MESSAGE_TYPES = [
        ...
        ('booking_created_agent', 'Booking Created - To Agent'),
        ('booking_created_admin', 'Booking Created - To Admin'),
        ('booking_approved_admin', 'Booking Approved - To Admin'),
        ('booking_declined_agent', 'Booking Declined - To Agent'),
        ('booking_declined_admin', 'Booking Declined - To Admin'),
